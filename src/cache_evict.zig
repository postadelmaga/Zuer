...
//!
//! COPIA GEMELLA di src/decoders/cache_evict.zig — tenerle in sync! Questa
//! copia serve l'host (meshcache.zig, vtcache.zig); quella in src/decoders/
//! serve il lato plugin (texcache.zig, usato da glb.so il cui module path è
//! src/decoders/).
